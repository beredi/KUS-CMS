...
function footer($whatKindOfPage){
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 hidden-sm hidden-xs">
            <p class="text-center top">&copy;KUS JÁNA KOLLÁRA SELENČA 2017 - '.date('Y').' | DESIGN BY xarocx</p>
        </div>
        <div class="hidden-lg hidden-md col-sm-12 col-xs-12">
            <p class="text-center top smallText">&copy;KUS JÁNA KOLLÁRA SELENČA 2017 - '.date('Y').' | DESIGN BY xarocx</p>
        </div>
    ...
    <div class="container" id="contact">
        <div class="row footerMargin">
            ...
            <div class="col-lg-3 col-lg-offset2 col-md-3 col-md-offset-2 col-sm-12 col-xs-12 ">
                <h3>Tajomníčka spolku:</h3>
                <p><span class="glyphicon glyphicon-user"></span> PaedDr. Svetlana Zolňanová</p>
            </div>
