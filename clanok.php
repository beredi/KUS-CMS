...
<div class="container content">
    ...
    <div class="row">
        ...
        <!-- BEZ PRAVEJ STRANY : POSLEDNE CLANKY
            ...
            <small><span class="glyphicon glyphicon glyphicon-calendar"></span> <?php echo $post_date; ?> | <span class="glyphicon glyphicon glyphicon-user"></span> <?php echo $post_author; ?> </small></h2>
<hr>
    <!---TEXT--->
