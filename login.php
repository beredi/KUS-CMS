...
<body class="text-center">
        ...
        <form class="form-signin" method="post" action="">
            ...
            <input autocomplete="off" type="email" name="user_email" id="inputEmail" class="form-control" placeholder="Zadajte email" required autofocus>
            <label for="inputPassword">Heslo</label>
            <input autocomplete="off" type="password" id="inputPassword" class="form-control" placeholder="Zadajte heslo" name="user_password" required>
