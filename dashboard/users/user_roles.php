...
<div class="row my-3">
    ...
    <table class="table table-bordered table-hover mb-3">
        ...
        <!-- ARTICLES-->
        <tr>
            <td colspan="5" class="bg-info text-white">Články <small>(každý užívateľ má právo upraviť svoj
                    článok)</small></td>
        </tr>
        <tr>
            <td>Pridať článok</td>
        ...
        <!-- USERS-->
        <tr>
            <td colspan="5" class="bg-info text-white">Užívatelia <small>(každý užívateľ môže upraviť svoj
                    profil)</small></td>
        </tr>
        <tr>
