                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div class="float-right">
                                    <a href="about.php?delete=<?= $id ?>" class="btn btn-lg btn-danger delete-button"><i
                                                class="far fa-trash-alt"></i> Vymazať túto sekciu</a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <form action="" method="post" enctype="multipart/form-data" class="my-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title" aria-describedby="title"
                                               placeholder="Názov sekcie" name="title" autocomplete="off"
                                               value="<?= $title ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="description">Popis:</label>
                                        <input type="text" class="form-control" id="description"
                                               aria-describedby="description" placeholder="Popis stránky"
                                               name="description" autocomplete="off" value="<?= $description ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="content">Obsah:</label>
                                        <textarea class="form-control" rows="10" id="content" name="content"
                                                  placeholder="Obsah" required><?= $content ?></textarea>
                                    </div>
                                    <input type="submit" class="btn btn-primary" name="submit_page"
                                           value="Aktualizovať">
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <form action="" method="post" enctype="multipart/form-data" class="my-2">
                                <div class="form-group">
                                    <label for="title">Názov sekcie:</label>
                                    <input type="text" class="form-control" id="title" aria-describedby="title"
                                           placeholder="Názov sekcie" name="title" autocomplete="off" value="">
                                </div>
                                <div class="form-group">
                                    <label for="description">Popis:</label>
                                    <input type="text" class="form-control" id="description"
                                           aria-describedby="description" placeholder="Popis stránky" name="description"
                                           autocomplete="off" value="">
                                </div>
                                <div class="form-group">
                                    <label for="content">Obsah:</label>
                                    <textarea class="form-control" rows="10" id="content" name="content"
                                              placeholder="Obsah" required></textarea>
                                </div>
