...
<form action="" method="post" enctype="multipart/form-data" class="my-2">
    ...
    <div class="form-group mt-3">
        ...
        <input type="text" class="form-control" id="user_function" placeholder="Zadajte funkciu užívateľa" name="user_function" aria-describedby="user_function" autocomplete="off">
    ...
    <div class="form-check">
        <input type="checkbox" class="form-check-input" name="user_role[]" value="moderator" id="moderator" tabIndex="1" onClick="ckChange(this)" disabled>
    ...
    <div class="form-check">
        <input type="checkbox" class="form-check-input" name="user_role[]" value="uzivatel" id="uzivatel" tabIndex="1" onClick="ckChange(this)" checked>
        <label class="form-check-label" for="uzivatel">Užívateľ</label>


    </div>

    <input type="submit" class="btn btn-primary my-1 float-right" style="width: 50%;" name="add_user" value="Pridať">
