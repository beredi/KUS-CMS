		...
		try {
            ...
            <form action="" method="post" enctype="multipart/form-data" class="my-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" placeholder="Zadajte názov súboru" name="name"
                           required autocomplete="off" value="<?= $file['name'] ?>">
                </div>
                <div class="form-group">
                    <label for="description">Popis:</label>
                    <input type="text" class="form-control" id="description" placeholder="Zadajte popis súboru"
                           name="description" autocomplete="off" value="<?= $file['description'] ?>">
                </div>
                <div class="form-group">
