...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="card text-right" style="width: 100%;">
                        <div class="card-body">
                            ...
                            <a href="posts.php?source=add_post" class="card-link"><i class="fas fa-pencil-alt"></i>
                                Pridať článok</a>
            ...
            <div class="row">
                <div class="col-md-12">
                    <button class="btn btn-outline-primary text-left mb-3" data-toggle="collapse" data-toggle="collapse"
                            href="#clanky" role="button" aria-expanded="true" aria-controls="clanky"
                            style="width: 100%;">
            ...
            <div class="row mt-2">
                <div class="col-md-12">
                    <button class="btn btn-outline-primary text-left mb-3" data-toggle="collapse" data-toggle="collapse"
                            href="#uzivatelia" role="button" aria-expanded="true" aria-controls="uzivatelia"
                            style="width: 100%;">
