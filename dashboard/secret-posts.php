			...
			try {
				...
				while ($row = $send_info->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    <div class="row secret-msg-row">
                        <div class="col-sm-12"
                             style="border-bottom: 1px solid #eeeeee; padding: 0 0 1px 15px; margin: 0px;">
                            <p style="font-size: 10px; margin: 0px; padding: 0px;">
                                <strong><?= $date ?></strong>
                            </p>
                        </div>
                        <a href="secret-posts.php?delete=<?= $id ?>" class="btn btn-danger btn-sm delete-button"
                           style="position:absolute; right: 50px; display: block; z-index: 100">X</a>
                        <div class="col-sm-12">
