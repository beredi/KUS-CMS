...
<div class="col-md-6 col-sm-12">
	<form action="" method="post" enctype="multipart/form-data" class="my-2">
		...
		<div class="form-group">
			...
			<input type="date" class="form-control" id="dateofbirth" placeholder="Zadajte dátum narodenia" name="dateofbirth" autocomplete="off" value="<?=$dateofbirth?>">
			<small id="user_function" class="form-text text-muted"><span class="text-info">MESIAC / DEN / ROK</span></small>
		</div>
		<div class="form-group">
			<label for="adress">Adresa:</label>
			<input type="text" class="form-control" id="adress" placeholder="Zadajte adresu" name="adress" autocomplete="off" value="<?=$adress?>">
		...
		<div class="form-group">
			...
			<input type="number" class="form-control" id="JMBG" placeholder="Zadajte JMBG" name="JMBG" autocomplete="off" value="<?=$JMBG?>">
		</div>
		<div class="form-group">
			<label for="number">Telefónne číslo:</label>
			<input type="text" class="form-control" id="number" placeholder="Zadajte tel. číslo" name="number" autocomplete="off" value="<?=$number?>">
			<small id="user_function" class="form-text text-muted">V medzinárodnom tvare: <span class="text-info">+381XXXXXXX</span></small>
		</div>
		<div class="form-group">
			<label for="email">Email:</label>
			<input type="email" class="form-control" id="email" placeholder="Zadajte email" name="email" autocomplete="off" value="<?=$email?>">
		</div>
		<div class="form-group">
			<label for="passnumber">Číslo cestovného pasu:</label>
			<input type="text" class="form-control" id="passnumber" placeholder="Zadajte číslo pasu" name="passnumber" autocomplete="off" value="<?=$passnumber?>">
		</div>
		...
		<div class="form-group">
			...
			<input type="number" class="form-control" id="year" placeholder="Zadajte rok" name="year" autocomplete="off" value="<?=$year?>">
		</div>
		<input type="submit" class="btn btn-primary my-1 float-right" style="width: 50%;" name="edit_member" value="Upraviť">
